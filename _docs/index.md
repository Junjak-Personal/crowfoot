...
| planning | `cli-distribution` | [2026-08-05-cli-distribution-debranding](./active/planning/2026-08-05/2026-08-05-cli-distribution-debranding.md) | 브랜딩 탈-Liam + 별도 리포 분리. **상표 확정(`crowfoot`) + 개명 sweep 완료 → `crowfoot` 0.1.0.** 1·2·5 완료, 앱 브랜딩 인벤토리 9파일 남음. §4 귀속 헤더는 보존 |
